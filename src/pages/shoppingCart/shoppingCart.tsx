...
class ShoppingCart extends Component<any, IShoppingCartProps> {
            ...
            shoppingList: [
                {
                    ...
                    'pro_num': 2,//数量
                    'pro_img': 'https://image-static.segmentfault.com/307/484/3074840158-5cbb1c568bcaf_articlex',//图片链接
                    'pro_price': 800//单价
                },
                {
                    'pro_id': 2,
                    ...
                    'pro_depot': '上海仓海仓储',
                    'pro_num': 3,
                    'pro_img': 'https://image-static.segmentfault.com/307/484/3074840158-5cbb1c568bcaf_articlex',
                    'pro_price': 800
                }
            ]
        };
     ...
     */
    changeNum(index:number, type?:string) {
        let _list = JSON.parse(JSON.stringify(this.state.shoppingList));
        if (type) {
            _list[index].pro_num++;
        }
